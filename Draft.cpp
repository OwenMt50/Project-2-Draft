...
int main(){
    ...
    if (vertical > strip){ //if statement that determines ending from input of int main, and possibility function
        ...
        cout<<"You hear don't hear the usual rock crumble from your pickaxe, instead a loud 'TING' and you shine your light onto what you just hit a moment ago.'EUREKA!!'\n.";
        cout<<"Congradulations, you have just struck gold! You are now destined to be the richest man West of the Missippi.\n";
        cout<<"+===========================+\n";
        cout<<"Game Over, mister millionare.\n";
        cout<<"+===========================+";
    }else if(vertical < strip){ 
        cout<<"You mined for what felt like an eternity...\n"; //bankrupt ending
        cout<<"All that is found within your strip mine are some copper veins, and low quality silver\n.";
        cout<<"'I bought all this land for crappy metals? I should have stayed in the big city, than try my luck!'\n";
